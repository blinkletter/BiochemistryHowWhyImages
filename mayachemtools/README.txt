...
and removal of salts from molecules; searching synthon spaces.
...
The command line Python scripts based on OpenMM provide functionality for
the following tasks: preparing macromolecule for simulation; performing
energy minimization; running MD simulation; performing simulated annealing.

The command line Python scripts based on OpenFE provide functionality for
the following tasks: calculation of partial charges; generation of ligand
networks; calculation of relative binding free energies; calculation of relative
hydration free energies; calculation of absolute hydration free energies.

The command line Python scripts based on AutoDock Vina provide functionality for
the following tasks: performing rigid and flexible docking; scoring molecules.
