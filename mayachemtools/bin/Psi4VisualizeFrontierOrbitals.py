    ...
    for Mol in Mols:
        ...
        for OrbitalID in CubeFilesInfo["OrbitalIDs"]:
            ...
            GenerateAndWritePMLForGroup(
                OutFH,
                PyMOLObjectNames["Orbitals"][OrbitalID]["OrbitalGroup"],
...
def WriteOrbitalSpinView(OutFH, CubeFilesInfo, PyMOLObjectNames, OrbitalID, SpinID, FirstSpin):
    ...
    GenerateAndWritePMLForGroup(
        OutFH,
        PyMOLObjectNames["Spins"][OrbitalID][SpinID]["SpinMeshGroup"],
    ...
    GenerateAndWritePMLForGroup(
        OutFH,
        PyMOLObjectNames["Spins"][OrbitalID][SpinID]["SpinSurfaceGroup"],
    ...
    GenerateAndWritePMLForGroup(
        OutFH,
        PyMOLObjectNames["Spins"][OrbitalID][SpinID]["SpinGroup"],
...
def RetrieveMolCubeFilesInfo(Mol, MolNum):
    ...
    for OrbitalID in ["HOMO", "LUMO", "DOMO", "LVMO", "SOMO"]:
        ...
        for CubeFile in CubeFiles:
            ...
            CubeFilesInfo["ContourWindowFactor"][OrbitalID][SpinID] = OptionsInfo["PyMOLViewParams"][
                "VolumeContourWindowFactor"
            ]
            CubeFilesInfo["ContourColorOpacity"][OrbitalID][SpinID] = OptionsInfo["PyMOLViewParams"][
                "VolumeColorRampOpacity"
            ]
            ...
            CubeFilesInfo["SetupLocalVolumeColorRamp"][OrbitalID][SpinID] = (
