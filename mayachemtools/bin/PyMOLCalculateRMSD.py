...
def CalculateRMSD(RefSelectionName, ProbeSelectionName, AlignMethod):
    ...
    if re.match("^align$", AlignMethod, re.I):
        Results = pymol.cmd.align(ProbeSelectionName, RefSelectionName)
        RMSD = Results[0]
    elif re.match("^cealign$", AlignMethod, re.I):
        Results = pymol.cmd.cealign(RefSelectionName, ProbeSelectionName)
        RMSD = Results["RMSD"]
    elif re.match("^super$", AlignMethod, re.I):
