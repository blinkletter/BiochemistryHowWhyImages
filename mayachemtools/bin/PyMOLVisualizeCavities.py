...
def WriteChainAloneCavitiesAndSurfacesView(OutFH, FileIndex, PyMOLObjectNames, ChainID):
    ...
    for SubGroupType in ["Cavities", "Surface"]:
        ...
        if GetChainAloneSurfaceChainStatus(FileIndex, ChainID):
            ...
            PML = PyMOLUtil.SetupPMLForHydrophobicSurfaceView(
                HydrophobicSurfaceName, ChainName, ColorPalette=OptionsInfo["SurfaceColorPalette"], Enable=False
            )
            OutFH.write("\n%s\n" % PML)
        ...
        if GetChainAloneSurfaceChainElectrostaticsStatus(FileIndex, ChainID):
            ...
            WriteSurfaceElectrostaticsView(
                ...
                SurfaceCavityMode=OptionsInfo["SurfaceCavityMode"],
            )

        # Setup surface group...
        GenerateAndWritePMLForGroup(
            OutFH,
            PyMOLObjectNames["Chains"][ChainID][SubGroupID],
