...
def PerformConstrainedMinimization():
    ...
    MiscUtil.PrintInfo(
        ...
        % (MolCount - ValidMolCount + CoreScaffoldMissingCount + MinimizationFailedCount)
    )
...
Usage:
    RDKitPerformConstrainedMinimization.py [--addHydrogens <yes or no>] [--conformerGenerator <SDG, KDG, ETDG, ETKDG, ETKDGv2>]
...
Options:
    ...
    -c, --conformerGenerator <text>  [default: ETKDGv2]
        ...
        pair of input and reference molecules. The atoms in common core scaffold 
