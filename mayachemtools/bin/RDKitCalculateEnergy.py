...
def WorkerProcess(EncodedMolInfo):
    ...
    CalcStatus, Energy = CalculateMoleculeEnergy(Mol, (MolIndex + 1))
...
def CalculateMoleculeEnergy(Mol, MolNum=None):
    "Calculate energy."
    ...
    if OptionsInfo["UseUFF"]:
        ...
        MiscUtil.PrintError(
            "Couldn't calculate nergy: Specified forcefield, %s, is not supported" % OptionsInfo["ForceField"]
        )
...
Usage:
    RDKitCalculateEnergy.py [--forceField <UFF, or MMFF>] [--forceFieldMMFFVariant <MMFF94 or MMFF94s>]
                            [--infileParams <Name,Value,...>] [--mp <yes or no>] [--mpParams <Name,Value,...>]
                            [ --outfileParams <Name,Value,...> ] [--overwrite] [--quiet <yes or no>] [-w <dir>] -i <infile> -o <outfile> 
    RDKitCalculateEnergy.py -h | --help | -e | --examples

Description:
    Calculate single point energy for molecules using a specified forcefield. The
    molecules must have 3D coordinates in input file.
...
Options:
    -f, --forceField <UFF, MMFF>  [default: MMFF]
        Forcefield method to use for energy calculation. Possible values: Universal Force
...
Examples:
    To calculate single point energy using MMFF forcefield for molecules in a SD file
    ...
    To calculate single point energy using UFF forcefield for molecules in a SD file
    containing 3D structures and write a new SD file, type:

        % RDKitCalculateEnergy.py -f UFF -i Sample3D.sdf -o Sample3DOut.sdf

    To calculate single point energy using MMFF94s variant of MMFF  forcefield for
    molecules in a SD file containing 3D structures and write a new SD file, type:
