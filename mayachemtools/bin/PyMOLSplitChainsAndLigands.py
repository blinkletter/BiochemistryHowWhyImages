...
def WriteChainFile(MolName, ChainID, ChainFile):
    ...
    pymol.cmd.save(ChainFile, ChainName)
...
def WriteLigandFile(MolName, ChainID, LigandID, LigandFile):
    ...
    pymol.cmd.save(LigandFile, LigandName)
...
Options:
    ...
    -m, --mode <Chains or ChainsLigands>  [default: ChainsLigands]
        ...
        together with chains in the output files for 'Chains' mode. Separate files
        are generated for ligands during 'ChainsAndLigands' mode.
